...
<head>
    ...
    <title>Owen Sign Up Website</title>
    <!-- Bootstrap CSS -->
...
<div class="navigation-header">
    <ul class="navigation-header-list">
        ...
        <li class="navigation-header-item">Tài khoản</li>
    </ul>
</div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-text">
                ...
                <p class="login-text">Hãy đăng ký ngay để tích lũy điểm thành viên và nhận được những ưu đãi tốt hơn!</p>
            </div>
            ...
            <form id="loginForm">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="dob" name="dob" placeholder="Chọn ngày">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="loginPassword1" placeholder="">
                </div>
                ...
                <button type="submit" id="btn-login" class="btn btn-primary btn-block"><a href="">Đăng Ký</a></button>
        ...
        <div class="col-md-6">
            <a href=""><img style="width: 100%;" src="https://owen.cdn.vccloud.vn/media/amasty/ampromobanners/OWEN_1_.jpg" alt=""></a>
        </div>
