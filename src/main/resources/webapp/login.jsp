    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-text">
                ...
                <p class="login-text">Nếu bạn đã có tài khoản, hãy đăng nhập để tích lũy điểm thành viên và nhận được những ưu đãi tốt hơn!</p>
            </div>
            ...
            <form id="loginForm">
                ...
                <button type="submit" id="btn-login" class="btn btn-primary btn-block"><a href="">Đăng Nhập</a></button>

                <button type="submit" id="btn-signup" class="btn btn-primary btn-block"><a href="">Tạo Tài Khoản</a></button>
            ...
            <div class="col-md-5">
                ...
                <ul class="footer-list">
                    <li class="footer-item">
                        <label for="" class="footer-item-text">
                            <strong>
